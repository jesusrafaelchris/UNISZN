...
class ListOfUsersFromUniversity: UITableViewController, UISearchBarDelegate, UISearchResultsUpdating {
  ...
  override func viewDidLoad() {
    ...
    getusers(university: University)
    ...
    func getusers(university: String) {
